  ...
  return (
    ...
    >
      ...
      <Container>
        ...
        <Box className="md:grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 flex-wrap xl:flex-nowrap md:gap-x-[30px] lg:gap-y-3 ">
          {transportOptions.map((option, idx) => (
            ...
            >
              <Paper
                ...
                className="rgba(255,255,255,0.1) !h-full min-h-[308px] lg:min-h-[300px] lg:p-[24px] lg:pb-[60px] p-[20px] pb-[60px]"
              >
                <Typography
