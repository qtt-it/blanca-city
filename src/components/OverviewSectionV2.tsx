...
const projectInfo = [
  ...
  },
  {
    ...
    value: (
      <>
        <GradientText text="50" />
        năm &
        <GradientText text="Sở hữu lâu dài" />
      </>
    ),
  },
  {
...
const OverviewSectionV2 = () => {
  ...
  return (
    ...
    >
      <Container
        id="overview"
        className="h-auto relative !lg:pb-0"
      ...
      >
        ...
        <Box className="relative !w-auto">
          <motion.div
            initial={{ opacity: 0, x: 100 }}
            whileInView={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8 }}
            viewport={{ once: true }}
            className="lg:w-full lg:top-[64px] w-full flex-1"
          >
            <h2
              style={{
          ...
          <Box className="lg:w-full grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:top-[112px] xl:top-[144px]  w-full mt-[20px]">
        ...
        <Box
          className="lg:mt-2 md:mt-[-60px] mt-[-60px]"
          sx={{
            // position: "absolute",
            top: { xs: "unset", md: 0 },
